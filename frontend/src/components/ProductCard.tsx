...
export const ProductCard = ({ product, handlePayment, onCartUpdate }: ProductCardProps) => {
    ...
    return (
        <div className="group bg-white border border-zinc-200 rounded-[2.5rem] overflow-hidden hover:border-zinc-900 transition-all duration-500 shadow-sm hover:shadow-2xl hover:shadow-zinc-200/50">
            ...
            <div className="p-8">
                <div className="mb-4">
                    <h3 className="font-bold text-zinc-900 text-xl tracking-tight leading-tight mb-2">{product.product_name}</h3>
                ...
                <div className="mt-8 flex items-end justify-between gap-4">
                    ...
                    <div className="flex flex-col gap-2 w-36">
                        ...
                        <button
                            ...
                            className="w-full bg-zinc-100 text-zinc-900 py-3 rounded-2xl text-[10px] font-black tracking-widest uppercase hover:bg-zinc-200 transition-all active:scale-95"
                        >
                            Instant Buy
                        </button>
                        ...
                        <div className="group/btn relative h-12">
                            <button className={`w-full h-full flex items-center justify-center gap-2 rounded-2xl text-[10px] font-black tracking-widest uppercase transition-all duration-300 ${isDone ? 'bg-emerald-500 text-white' : 'bg-zinc-900 text-white group-hover/btn:opacity-0 shadow-lg shadow-zinc-200'}`}>
